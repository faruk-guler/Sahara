...
Bunun için Zabbix, **HTTP Agent** mantığıyla (Modül 08) CloudWatch API'lerini doğrudan "Pull" (Çeker) mantığıyla sömürür.
...
2026 Observability standartı olan OTel kavramı; log, metrik ve trace (üçlü sütün) verilerinin Cihaz Bağımsız tek bir evrensel dilde toplanmasını amaçlar. Prometheus Metrikleri, Jaeger traceleri... Hepsi bu OTel sinyal havuzuna dökülür.
